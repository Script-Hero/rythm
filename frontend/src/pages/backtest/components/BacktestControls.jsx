...
import { CryptoSymbolSelector, ValidatedDatePickerNew } from "@/components/forms";
      ...
      <div className="flex flex-row lg:flex-row lg:items-center lg:justify-between px-4 lg:px-6 py-4 gap-4 w-9/10 m-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 lg:gap-6">
          <div className="flex items-center gap-10">
            ...
            <Button variant="outline" onClick={onClearChart} size="lg" className="hidden sm:flex bg-gray-300 text-gray-900 text-bold">
              Clear Results
            </Button>
            <Button variant="outline" onClick={onClearChart} size="lg" className="sm:hidden bg-gray-300 text-gray-900 text-bold">
              Clear
            </Button>
          </div>
        </div>
