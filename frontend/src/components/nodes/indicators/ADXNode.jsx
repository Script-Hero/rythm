...
function ADXNode({ data, id, updateNodeData }) {
  ...
  return (
    <div className="bg-green-100 border-2 border-green-300 rounded-lg p-3 min-w-32">
      <div className="font-semibold text-green-800 mb-2">ADX</div>
      <div className="text-xs text-gray-600 mb-2">Trend Strength</div>
