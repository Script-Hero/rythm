...
class CompiledStrategy:
    ...
    def execute(self, market_data: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        for i, node_id in enumerate(self.execution_order):
            ...
            logger.debug(f"⚡ Executing node {i+1}/{len(self.execution_order)}", 
                       node_id=node_id, 
            ...
            try:
                ...
                logger.debug("📥 Node inputs gathered", 
                           node_id=node_id, 
    ...
    def _gather_node_inputs(self, node_id: str, node_outputs: Dict[str, Dict], 
        ...
        logger.debug("📥 Gathering inputs for node", node_id=node_id)
        
        inputs = {}
        
        # Get inputs from connected nodes
        logger.debug("🔗 Checking for input connections")
        connections_found = 0
